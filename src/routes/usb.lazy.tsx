              ...
              <div className="tooltip-inner">
                ...
                <div className="text-content">
                  <p>
                    ...
                    mouse, USB drive, etc) through the USB_OTG port to supported
                    modules
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Flash</strong> - turns the module into flashing mode
                    and sets the USB_OTG into device mode - use to flash the
                    module using USB_OTG port
                  </p>
                </div>
              </div>
            </div>
